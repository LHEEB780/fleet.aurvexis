...
import { Home, ChevronLeft, ChevronRight, Folder, Truck, Users, LayoutDashboard, Wrench, BarChart3, IdCard, ClipboardCheck, Building2, Calendar, Warehouse, Handshake, ShieldCheck, CreditCard, Globe, Bot, Cloud, Video, HelpCircle } from 'lucide-react';
...
export const TAB_LABELS: Record<string, { ar: string; en: string; icon: React.ReactNode }> = {
  ...
  'help-center': { ar: 'مركز المساعدة ودليل الاستخدام', en: 'Help Center & Guides', icon: <HelpCircle size={14} /> },
